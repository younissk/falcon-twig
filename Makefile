...
fix-env:
	...
	@UV_PYTHON=3.11 uv pip install --index-url https://download.pytorch.org/whl/cu121 torch torchvision torchaudio
	@echo ""
	@echo "Step 3: Installing bitsandbytes first..."
	@UV_PYTHON=3.11 uv sync --extra cuda
	@echo ""
	@echo "Step 4: Installing fast kernels (mamba-ssm, causal-conv1d)..."
	@UV_PYTHON=3.11 uv pip install mamba-ssm causal-conv1d
	@echo ""
	@echo "Step 5: Installing flash-attn (may take a while)..."
	@UV_PYTHON=3.11 uv pip install flash-attn --no-build-isolation
	@echo ""
	...
	@echo ""
	@echo "Step 7: Testing training setup..."
